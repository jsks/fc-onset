...
Frozen conflicts are among some of the most pernicious, difficult to resolve conflicts. They are geographically and temporally dispersed, and although they are characterized by a cessation of large-scale hostilities, the underlying disputes remain unresolved. This puts actors into a state of uncertainty with an ever present threat of violent re-escalations and can lead to long-running accumulating costs.

Surprisingly, little scholarly attention has been paid to the factors influencing the emergence of frozen conflicts [@klosek_frozen_2021].


This paper seeks to address this gap by asking why do some conflicts become frozen?

Surprisingly, little scholarly attention has been
paid to the factors influencing their emergence. This paper addresses
