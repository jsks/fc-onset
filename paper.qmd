...
- Frozen conflicts as a suboptimal solution to the contest between an incumbent and challenger.
...
delta$group <- sapply(ll, `[`, 2) |> as.factor()
...
ame$group <- sapply(ll, `[`, 2) |> as.factor()
