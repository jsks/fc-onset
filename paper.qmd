...
In addition to the treatment variables I also include a set of covariates that could plausibly confound the relationship between external state support and frozen conflicts. This includes variables related to the following conflict dynamics: conflict episode duration, episode reoccurence within a conflict, and cumulative intensity. Conflicts which last longer may affect the willing of third party actors to offer support to conflict actors. Simulatenously, long-running conflicts may also be at a greater risk of becoming frozen since the protracted nature of the conflict indicates an inability for either side to achieve a one-sided victory or be willing to reach a compremise through a peace agreement. We could expect the costs to increase such that active fighting ceases; however, the underlying conflict remains unresolved and the conflict transitions to being frozen. Thus, I include the log of the duration for each episode. A similar logic may also apply to episode reoccurence. Recurring episodes can also indicate an intractable long-running conflict that may affect both external support and the likelihood for a conflict to become frozen. Therefore, I include a binary indicator variable for whether an episode is is a recurring episode within a larger conflict as identified by the UCDP. Finally,

This includes three variables related to conflict dynamics: conflict episode duration, episode reoccurence within a conflict, and cumulative intensity. Conflicts which last longer may affect the willingness of third party actors to provide support to conflict actors. Either
...
In other words, the crucial predictor for whether an intra-state conflict terminates as a frozen conflict is whether the opposition received external support by a third party state during the conflict episode



. Meanwhile, external support directed to the government is fairly uninformative for the outcome.
