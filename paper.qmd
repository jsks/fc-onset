...
@fig-delta shows the posterior densities for the three treatment parameters varied by conflict incompatibility.
...
#|     for the treatment parameters in the hierarchical probit model
#|     predicting whether a civil conflict episodes terminates as a
#|     frozen conflict. Point estimates are the posterior medians.
...
#|     three treatment conditions on the predicted probability of a
#|     frozen conflict onset with 50% and 90% credible
#|     intervals. Point estimates are the posterior medians.
