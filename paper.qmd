...
crucially, the expected utility of maintaining the dispute outweighs the potential gain from a peace agreement.
...
```{R cache=F}
output <- system("scripts/wordcount.sh paper.qmd", intern = T)
wc <- gsub("[^\\d]", "", output, perl = T)
```
